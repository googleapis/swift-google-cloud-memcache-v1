...
extension Clients {
  final class CloudMemcacheLogging: CloudMemcacheStub {
    let inner: any CloudMemcacheStub
    let logger: Logger

    public init(_ inner: any CloudMemcacheStub, logger: Logger) {
      var logger = logger
      logger[metadataKey: "gcp.artifact.id"] = "google-cloud-memcache-v1"
      logger[metadataKey: "gcp.client.service"] = "memcache"
      logger[metadataKey: "gcp.experimental.swift.client"] = "CloudMemcache"
      self.inner = inner
      self.logger = logger
    }
    ...
    public func updateParameters(
      ...
      try await self._intercept(
        ...
        action: {
          (r: UpdateParametersRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleLongRunning.Operation
          in
          return try await self.inner.updateParameters(request: r, options: o)
        })
    }
    ...
    public func applyParameters(
      ...
      try await self._intercept(
        ...
        action: {
          (r: ApplyParametersRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleLongRunning.Operation
          in
          return try await self.inner.applyParameters(request: r, options: o)
        })
    }
